...
#include <GLES2/gl2.h> // WebGL / OpenGL ES 2 in the browser (matches the ImGui backend's Emscripten default)
#else
...
ImTextureID Sprite::_loadTextureFromMemory(const unsigned char *image_data, int image_width, int image_height)
{
    ...
    // Required on WebGL / OpenGL ES 2 for non-power-of-two textures, otherwise they
    // are "incomplete" and sample as solid black (the chess pieces/board squares are NPOT).
